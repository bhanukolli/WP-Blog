...
if ( ! function_exists( 'ac_css_files' ) ) {  
	...
	function ac_css_files() {
		...
		// Enqueue
		wp_enqueue_style( 'ac_style', get_stylesheet_uri(), array(), '1.0.3', 'all' );
...
if ( ! function_exists( 'ac_js_files' ) ) {
	...
	function ac_js_files() {
		...
		wp_enqueue_script( 'ac_js_myscripts', get_template_directory_uri() . '/assets/js/myscripts.js', array('jquery'), '1.0.3', true );
