 ...
 */
	...
	*/
	...
	function theme_scripts_method() {
		...
		$tickertape= get_template_directory_uri() . "/js/tickertape.js";
		wp_deregister_script( 'tickertape' );
		wp_register_script( 'tickertape', $tickertape);
		wp_enqueue_script( 'tickertape');
