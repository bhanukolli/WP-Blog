			...
			<div id="headcontainer">
				<header class="group">
					<div class="header_first">
						<?php tickertape(); // SCROLLING TICKERTAPE ?>
					</div>
				...
				<div class="break"></div>
				<div id="expand_member_content">
					<div class="auto">
						<?php membershiparea(); // MEMBERSHIP LOGIN ?>
					</div>
				</div>
				<div class="break"></div>
				<div id="expand_search_content">
					<div class="auto">
						<?php searchfield(); // SEARCH FIELD ?>
					</div>
				</div>
				<div class="break"></div>
				<div id="expand_social_content">
					<div class="auto">
            ...
            <div id="subheadcontainer">
                <div id="subheadcontent">
                    <div class="section group"><!-- section -->
                        <div class="col span_5_of_5 trans unlimited"><!-- col -->
