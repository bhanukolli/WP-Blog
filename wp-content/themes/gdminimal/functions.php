...
function cyberchimps_posted_on() {
	...
	$posted_on = sprintf( '<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s /</time></a>%10$s <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author"> %7$s /</a></span>%11$s',
		esc_url( get_permalink() ),
		esc_attr( get_the_time() ),
		esc_attr( get_the_date( 'c' ) ),
		( $show_date ) ? esc_html( get_the_date( 'm/d/y') ) : '',
